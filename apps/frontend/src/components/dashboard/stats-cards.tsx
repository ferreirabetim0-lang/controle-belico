...
export function StatsCards() {
  ...
  const { data: financial, loading: loadingFin } = useApi(() => dashboard.financialSummary(), [])
  ...
  const cards = [
    ...
    },
    {
      ...
      value: loading ? '...' : String(stats?.openNotifications ?? 0),
      icon: Bell,
      color: 'text-[#D50000]',
      bg: 'bg-[#D50000]/10',
    },
    {
      ...
      value: loading ? '...' : formatCurrency(financial?.totalIncome ?? 0),
      icon: DollarSign,
      color: 'text-[#00C853]',
      bg: 'bg-[#00C853]/10',
    },
    {
      ...
      value: loading ? '...' : formatCurrency(financial?.totalExpenses ?? 0),
      icon: TrendingDown,
      color: 'text-[#D50000]',
      bg: 'bg-[#D50000]/10',
    },
    {
      label: 'Lucro do Mês',
      value: loading ? '...' : formatCurrency(financial?.profit ?? 0),
      icon: TrendingUp,
      color: 'text-[#00C853]',
      bg: 'bg-[#00C853]/10',
    },
    {
      label: 'Margem do Mês',
      value: loading ? '...' : `${(financial?.margin ?? 0).toFixed(1)}%`,
      icon: TrendingUp,
      color: 'text-[#3E92CC]',
      bg: 'bg-[#3E92CC]/10',
    },
